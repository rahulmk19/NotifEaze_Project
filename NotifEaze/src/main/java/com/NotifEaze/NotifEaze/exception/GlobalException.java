...
public class GlobalException {
	...
	@ExceptionHandler(NotifEazeException.class)
	public ResponseEntity<MyErrorDetails> StudentExceptionHandler(NotifEazeException notifEaze, WebRequest req) {

		MyErrorDetails error = new MyErrorDetails(notifEaze.getMessage(), req.getDescription(false),
				LocalDateTime.now());
